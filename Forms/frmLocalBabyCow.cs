...
{
    public partial class frmLocalBabyCow : Form
    {
        private Product _product;

        public frmLocalBabyCow()
        {
            InitializeComponent();
        }

        private void frmLocalBabyCow_Load(object sender, EventArgs e)
        {
            try
            {
                _product = ProductRepository.GetByCategory("LocalBabyCow");
        ...
        {
            // Takes the user back to the previous page (frmBabyCow).
            this.Close();
        }
