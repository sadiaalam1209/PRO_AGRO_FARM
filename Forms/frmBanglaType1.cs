...
{
    public partial class frmBanglaType1 : Form
    {
        private Product _product;

        public frmBanglaType1()
        {
            InitializeComponent();
        }

        private void frmBanglaType1_Load(object sender, EventArgs e)
        {
            try
            {
                _product = ProductRepository.GetByCategory("BanglaType1");
        ...
        private void lblMeat_Click(object sender, EventArgs e)
        {
