...
{
    public partial class frmCowHide : Form
    {
        ...
        private void frmCowHide_Load(object sender, EventArgs e)
        {
            try
            {
                _product = ProductRepository.GetByCategory("CowHide");
            ...
            {
                MessageBox.Show("Could not load Cow Hide price: " + ex.Message, "Database Error",
