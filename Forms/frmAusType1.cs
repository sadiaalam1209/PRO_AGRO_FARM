...
{
    public partial class frmAusType1 : Form
    {
        ...
        private void frmAusType1_Load(object sender, EventArgs e)
        {
            try
            {
                _product = ProductRepository.GetByCategory("AusType1");
        ...
        {
            // Takes the user back to the previous page (frmAustralianCow).
            this.Close();
        }
