...
{
    public partial class frmButter : Form
    {
        ...
        private void frmButter_Load(object sender, EventArgs e)
        {
            LoadProduct();
        }
        ...
        private void LoadProduct()
        {
            try
            {
                _product = ProductRepository.GetByCategory("Butter");
            ...
            {
                MessageBox.Show("Could not load Butter price: " + ex.Message, "Database Error",
