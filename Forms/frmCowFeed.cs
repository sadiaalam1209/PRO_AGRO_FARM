...
{
    public partial class frmCowFeed : Form
    {
        ...
        private void frmCowFeed_Load(object sender, EventArgs e)
        {
            lblMeat.Text = "PRODUCT :  COW FEED"; // leftover label name from copy, text fixed here

            try
            {
                _product = ProductRepository.GetByCategory("CowFeed");
            ...
            {
                MessageBox.Show("Could not load Cow Feed price: " + ex.Message, "Database Error",
