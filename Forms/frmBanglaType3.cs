...
{
    public partial class frmBanglaType3 : Form
    {
        private Product _product;

        public frmBanglaType3()
        {
            InitializeComponent();
        }

        private void frmBanglaType3_Load(object sender, EventArgs e)
        {
            try
            {
                _product = ProductRepository.GetByCategory("BanglaType3");
