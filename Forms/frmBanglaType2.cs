...
{
    public partial class frmBanglaType2 : Form
    {
        private Product _product;

        public frmBanglaType2()
        {
            InitializeComponent();
        }

        private void frmBanglaType2_Load(object sender, EventArgs e)
        {
            try
            {
                _product = ProductRepository.GetByCategory("BanglaType2");
