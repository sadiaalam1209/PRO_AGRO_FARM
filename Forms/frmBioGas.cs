...
{
    public partial class frmBioGas : Form
    {
        ...
        private void frmBioGas_Load(object sender, EventArgs e)
        {
            try
            {
                _product = ProductRepository.GetByCategory("BioGas");
            ...
            {
                MessageBox.Show("Could not load Bio Gas price: " + ex.Message, "Database Error",
